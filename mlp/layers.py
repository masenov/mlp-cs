...
class Sigmoid(Linear):
    ...
    def sigmoid(self, a):
        return numpy.divide(1, 1 + numpy.exp(-a))
    ...
    def bprop(self, h, igrads):
        ...
        deltas = igrads * numpy.multiply(self.sigmoid(h),1-self.sigmoid(h))
...
class Softmax(Linear):
    ...
    def fprop(self, inputs):
        ...
        a = Linear.fprop(self, inputs)
        exps = numpy.sum(numpy.exp(a), axis=1);        
        h = numpy.exp(a)/exps[:,None]
